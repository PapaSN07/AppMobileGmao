...
# Bypass proxy entirely to avoid 'ProxyError'
direct_proxies = {
    "http": None,
    "https": None,
}

log_file_path = "coswin_api_diagnostic_v11.txt"
...
with open(log_file_path, "w", encoding="utf-8") as f:
    f.write("=== COSWIN API DIAGNOSTIC V11 LOG ===\n")

log("Starting Coswin API diagnostics V11 (Bypassing Proxy)...")

# We will test different column names with 'equals' and direct connection
columns = [
    "wowoActionEntity",
    "WOWO_REQUEST_ENTITY",
    "WOWO_ACTION_ENTITY",
...
for col in columns:
    ...
    try:
        # Pass proxies=direct_proxies to ignore system HTTP_PROXY settings
...
log("\nDiagnostics V11 complete. Output saved to coswin_api_diagnostic_v11.txt")
