...
class ResponsiveSpacing {
  ...
  EdgeInsets custom({
    ...
    return EdgeInsets.only(
      left: _responsive.spacing(left ?? horizontal ?? 0),
      right: _responsive.spacing(right ?? horizontal ?? 0),
      top: _responsive.spacing(top ?? vertical ?? 0),
      bottom: _responsive.spacing(bottom ?? vertical ?? 0),
    );
  }
